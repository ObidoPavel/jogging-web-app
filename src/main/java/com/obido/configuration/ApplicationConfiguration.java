...
class ApplicationConfiguration {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws SQLException {
        ...
        factory.setDataSource(environmentConfiguration.dataSource());
        factory.setJpaVendorAdapter(environmentConfiguration.jpaVendorAdapter());
    ...
    public NamedParameterJdbcTemplate namedParameterJdbcTemplate() throws SQLException {
        return new NamedParameterJdbcTemplate(environmentConfiguration.dataSource());
    }
}
